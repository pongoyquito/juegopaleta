  ...
  //--- Definir los estados/ciclos del juego
    ...
    function create() {
      //... Inicia var. texto puntos en objeto GAME
		puntosText = game.add.text(32, (alto*7/8), 'Puntos: ' + puntos, { font: "20px Arial", fill: "#ffffff", align: "left" });
		vidasText = game.add.text((ancho - 100), (alto*7/8), 'vidas: ' + vidas, { font: "20px Arial", fill: "#ffffff", align: "left" });
		introText = game.add.text(game.world.centerX, (alto/2), '- click to start -', { font: "30px Arial", fill: "#ffffff", align: "center" });
